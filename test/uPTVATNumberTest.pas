...
type
  ...
  public
    ...
    [TestCase('Invalid 1','111111111,222222222,False')]
    [TestCase('Invalid 2','123,321,False')]
    procedure AsIntegerTest(const VATNumberIn: string; VATNumberOut: Integer; const Expected: Boolean);
  end;
...
procedure TPTVATNumberTest.AsIntegerTest(const VATNumberIn: string;
  VATNumberOut: Integer; const Expected: Boolean);
begin
  Assert.AreEqual(
    Expected,
    VATNumberOut = TPTVATNumber.New(VATNumberIn).AsInteger
  );
end;
