...
type
    ...
    public
      constructor Create(Origin: IIntegerRange);
      function Includes(const Value: Int64): Boolean;
      function Excludes(const Value: Int64): Boolean;
    End;
    ...
    strict private
      FOrigin: IFloatRange;
    public
      constructor Create(Origin: IFloatRange);
      function Includes(const Value: Extended): Boolean;
      function Excludes(const Value: Extended): Boolean;
    End;
    ...
    strict private
      FOrigin: ICharRange;
    public
      constructor Create(Origin: ICharRange);
      function Includes(const Value: Char): Boolean;
      function Excludes(const Value: Char): Boolean;
    End;
...
constructor TAggregatedIntegerRange.Create(Origin: IIntegerRange);
begin
     FOrigin := Origin;
end;
...
constructor TAggregatedFloatRange.Create(Origin: IFloatRange);
begin
     FOrigin := Origin;
end;
...
constructor TAggregatedCharRange.Create(Origin: ICharRange);
begin
     FOrigin := Origin;
end;
